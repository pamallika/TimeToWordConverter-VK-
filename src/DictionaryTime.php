...
class DictionaryTime implements DictionaryTimeInterface
{
    ...
    {
        return self::dictionaryAfterHours[$hour];
    }
    ...
    {
        return self::dictionaryBeforeHours[$hour];
    }
    ...
    {
        return self::dictionaryHalfHours[$hour];
    }
    ...
    {
        return self::dictionaryMinutes[$minute];
    }
    ...
    {
        return  self::dictionaryHours[$hour];
    }
}